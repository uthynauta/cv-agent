...
# CV — Othón González
- **Source path:** `wiki/raw/cv/CV-OGC-AI.tex`
- **Source kind:** LaTeX
- **SHA256:** `7bb63ac90d1879851fbe652f5b2b95f5173e4b67cee23dea51e7d4e407227372`
- **Profile:** Senior AI / LLM Engineer based in Mexico City, Mexico.
- **Contact:** [LinkedIn](https://linkedin.com/in/othongc) · [GitHub](https://github.com/uthynauta) · `othon.gonzalezc@gmail.com`
- **Primary evidence pages:** [[entities/othon-gonzalez]], [[experience/teradata-agentic-ai]], [[experience/continental-adas]], [[experience/centrogeo-research]], [[education/academic-background]], and [[publications/selected-publications]].
...
AI Engineer / Agentic AI Platform Engineer

- Developed core capabilities for an internal enterprise Agentic AI
...
- Engineered LLM-based workflows using LangGraph, structured tool
execution, reusable agent skills, MCP-based integrations, and
Retrieval-Augmented Generation.

- Contributed to a scalable platform architecture initially supporting
...
- Designed an OpenTelemetry-based observability architecture that
...
- Integrated telemetry and monitoring components using Grafana,
...
- Built structured evaluation and analytics pipelines using
...
- Developed AI-assisted testing and data-processing tools for radar
and multi-sensor perception systems, improving the efficiency and
repeatability of model-validation workflows.

- Generated and curated simulated radar datasets in dSPACE for training and evaluating radar-virtualization models under controlled and reproducible scenarios.

- Built automated engineering workflows for test-data processing,
validation activities, and repetitive analysis tasks using Python and
workflow-automation tooling.

- Designed and executed validation strategies for radar, camera, and
LiDAR perception pipelines, supporting system reliability in
safety-critical automotive environments.

- Applied computer vision models and tooling including DETR, YOLO,
Segment Anything, and CVAT in perception-data and validation workflows.

- Supported cross-functional collaboration among algorithm,
validation, data, simulation, and systems-engineering teams.

- Contributed to a strategic cooperation agreement with the National
...
- Researched and developed NLP and multimodal deep-learning models
for generative tasks, with emphasis on automatic image and video
captioning.

- Architected and trained models based on recurrent neural networks,
LSTMs, attention mechanisms, and Transformers for vision-language
research problems.

- Designed experimental workflows for evaluating caption-generation
systems and analyzing whether commonly used metrics reflected semantic
and perceptual output quality.

- Used PyTorch, Transformers, and Hugging Face tools for model
development, experimentation, training, and inference.

- Managed datasets and computational workflows for model training,
inference, comparison, and reproducible experimentation.

- Evaluated generative-image technologies including DALL-E and
Stable Diffusion for research-oriented applications.

- Co-authored peer-reviewed publications on video captioning,
multimodal-model evaluation, and computer vision.

## Earlier Engineering and Leadership Experience
...
- Led operational-safety and compliance initiatives for a Mexican
ground-handling services provider operating in a regulated aviation
environment.

- Supported certification of the Toluca station under IS-BAH
Safety Stages 1 and 2.

- Coordinated with Mexican authorities to resolve a critical permit
...
Regional Airports Chief and Processes Analyst

- Served as liaison between regional airport operations and corporate
headquarters, coordinating process alignment and operational follow-up.

- Owned and improved a national KPI for baggage irregularities,
applying data analysis to strengthen tracking and operational control.

- Supported ISAGO certification renewal and participated in
regulatory and operational audits.

ITESM, UVM and CentroGeo
...
CICATA Querétaro, Instituto Politécnico Nacional, 2020

Research focus: Computer Vision and Remote Sensing

Thesis: Precise Remote Measurement of Thermal Radiance Dynamics
...
CICATA Querétaro, Instituto Politécnico Nacional, 2016

Research focus: Aerodynamic Optimization and Morphing Systems

Thesis: Data-Driven Morphable Wing for Tracking and Mapping
...
ESIME Ticomán, Instituto Politécnico Nacional, 2010

Thesis: Software Tool to Determine the Capacity of Different
Runway Systems
...
- González-Chávez, O., et al.
``Are Metrics Measuring What They Should? Evaluation of Image
Captioning Task Metrics.''
Signal Processing: Image Communication, Vol. 120, 2024.

- Moctezuma, D., et al.
``Video Captioning: A Comparative Review.''
Computer Vision and Image Understanding, Vol. 231, 2023.
...
Mexican Conference on Pattern Recognition, 2019.
